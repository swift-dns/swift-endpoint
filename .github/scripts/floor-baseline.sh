...
readonly granularity=10000     # 10µs in nanoseconds
...
# and floored to 10µs; otherwise the provided 'fixed_value' is used verbatim (for the self-test).
inject_cpu_user_p90() {
...
log "✅ Floored measured cpuUser p90 to 10µs in ${floored_count} baseline file(s)."
