...
# Floors '.cpuUser' min and max (or a scalar absolute value) down to the 10µs granularity.
...
log "✅ Floored cpuUser thresholds (min and max) to 10µs in ${floored_count} file(s)."
