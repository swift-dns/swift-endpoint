...
let portFromStringBenchmarks: @Sendable () -> Void = {
    ...
    Benchmark(
        ...
        blackHole("9" as Port)
        blackHole("21" as Port)
        blackHole("22" as Port)
        blackHole("23" as Port)
        blackHole("25" as Port)
        blackHole("53" as Port)
        blackHole("80" as Port)
        blackHole("110" as Port)
        blackHole("123" as Port)
        blackHole("143" as Port)
        blackHole("179" as Port)
        blackHole("389" as Port)
        blackHole("443" as Port)
        blackHole("514" as Port)
        blackHole("587" as Port)
        blackHole("853" as Port)
        blackHole("993" as Port)
        blackHole("995" as Port)
        blackHole("1194" as Port)
        blackHole("1433" as Port)
        blackHole("2049" as Port)
        blackHole("3306" as Port)
        blackHole("3389" as Port)
        blackHole("5060" as Port)
        blackHole("5353" as Port)
        blackHole("5432" as Port)
        blackHole("6379" as Port)
        blackHole("8080" as Port)
        blackHole("8443" as Port)
        blackHole("11211" as Port)
        blackHole("27017" as Port)
        blackHole("33435" as Port)
    }
