...
| ------- | ----------- | ------------- | ------------ | ------- |
| IPv4    | Serializing | 6.0           | 180.0        | 30.00x  |
| IPv4    | Parsing     | 15.2          | 47.3         | 3.11x   |
| IPv6    | Serializing | 29.5          | 222.0        | 7.53x   |
| IPv6    | Parsing     | 25.2          | 100.3        | 3.98x   |
...
| IPv4    | Parsing     | 17.1          | 26.5         | 1.55x   |
| IPv6    | Serializing | 36.5          | 165.0        | 4.52x   |
