...
private let ipv4StringAndAddressTestCases: [(String, IPv4Address?, Bool)] =
    [
        ...
        ("1.2.3.4\t", nil, false),
        ("1.2 .3.4", nil, false),
        ("0x7f.0.0.1", nil, false),
        ("0xff.0xff.0xff.0xff", nil, false),
        ("+1.2.3.4", nil, false),
        ("1.2.3.+4", nil, false),
        ("1.2.3.-4", nil, false),
        ("999.999.999.999", nil, false),
        ("1..2.3", nil, false),
    ...
    ] + ipv4BoundaryCharactersTestCases
...
private let ipv6StringAndAddressTestCases: [(String, IPv6Address?, Bool)] =
    [
        ...
        ("[::ffff:1.1.1.1]", 0x0000_0000_0000_0000_0000_FFFF_0101_0101, false),
        ("64:ff9b::192.0.2.33", 0x0064_FF9B_0000_0000_0000_0000_C000_0221, false),
        ("[64:ff9b::192.0.2.33]", 0x0064_FF9B_0000_0000_0000_0000_C000_0221, false),
        ("2001:db8:122:344::192.0.2.33", 0x2001_0DB8_0122_0344_0000_0000_C000_0221, false),
        ("::13.1.68.3", 0x0000_0000_0000_0000_0000_0000_0D01_4403, false),
        ("0:0:1:0:0:FFFF:204.152.189.116", 0x0000_0000_0001_0000_0000_FFFF_CC98_BD74, false),
        ...
        ("::FFFF:1.1.1.", nil, false),
        ("::1.1.1.1", 0x0000_0000_0000_0000_0000_0000_0101_0101, false),
        (".1.1.1.1", nil, false),
        ...
        ("::1\n", nil, false),
        ("::1\t", nil, false),
        ("::FFFF:1.2.3.4 ", nil, false),
        ("fe80::1%eth0", nil, false),
        ("::ffff:1.2.3.4.5", nil, false),
        ("::ffff:1.2.3.4:", nil, false),
        ("::ffff:1.2.3", nil, false),
        ("::ffff:0x1.2.3.4", nil, false),
        ("::ffff:999.1.1.1", nil, false),
        ("1::2:3:4:5:6:7:8", nil, false),
        ("0:00:000:0000:0:0:0:0", 0, false),
    ...
    ] + ipv6BoundaryCharactersTestCases
...
private let ipv4BoundaryCharacters: [UInt8] = [
    UInt8(ascii: ".") - 1, UInt8(ascii: ".") + 1,
    UInt8(ascii: "0") - 1, UInt8(ascii: "9") + 1,
]

private let ipv4BoundaryCharactersTestCases: [(String, IPv4Address?, Bool)] =
    ipv4BoundaryCharacters.map { utf8Byte in
        let char = String(UnicodeScalar(utf8Byte))
        return ("127.0.\(char).1", nil, false)
    }
...
private let ipv6BoundaryCharactersTestCases: [(String, IPv6Address?, Bool)] =
    ipv6BoundaryCharacters.map { utf8Byte in
        let char = String(UnicodeScalar(utf8Byte))
        return ("::1:\(char):1", nil, false)
    }
