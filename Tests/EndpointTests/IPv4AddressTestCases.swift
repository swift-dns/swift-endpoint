...
extension IPTestCase where IPAddressType == IPv4Address {
    static var stringAndAddress: [Self] {
        [
            ...
            IPTestCase(
                "192.168.1.98",
                IPv4Address(192, 168, 1, 98),
                canonicalDescription: "192.168.1.98"
            ),
            IPTestCase(
                "120.102.12.100",
                IPv4Address(120, 102, 12, 100),
                canonicalDescription: "120.102.12.100"
            ),
            IPTestCase("192.168.1.256"),
            IPTestCase("192.168.1."),
            IPTestCase("1111.168.1.1"),
            IPTestCase("192.168.1.2.3"),
            IPTestCase("192.168.1"),
            IPTestCase(".168.1.123"),
            IPTestCase("168.1.123"),
            IPTestCase("-1.168.1.123"),
            IPTestCase("1.-168.1.123"),
            IPTestCase("1.-168.1.0xaa"),
            IPTestCase("1.-168.1.aa"),
            IPTestCase("9"),
            IPTestCase("9.87"),
            IPTestCase(""),
            IPTestCase(" "),
            ...
            IPTestCase("1.2.3.4\t"),
            IPTestCase("1.2 .3.4"),
            IPTestCase("0x7f.0.0.1"),
            IPTestCase("0xff.0xff.0xff.0xff"),
            IPTestCase("+1.2.3.4"),
            IPTestCase("1.2.3.+4"),
            IPTestCase("1.2.3.-4"),
            IPTestCase("999.999.999.999"),
            IPTestCase("1..2.3"),
            IPTestCase(
                "1111:2222:3333:4444:5555:6666:7777:8888",
                isValidAsOtherIPVersion: true
            ),
            IPTestCase("::1", isValidAsOtherIPVersion: true),
...
extension IPTestCase where IPAddressType == IPv4Address {
    private static var boundaryCharacters: [Self] {
        ipv4BoundaryCharacters.map { utf8Byte in
            ...
            return IPTestCase("127.0.\(char).1")
        }
    }
}
