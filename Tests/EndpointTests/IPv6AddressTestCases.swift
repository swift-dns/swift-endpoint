...
extension IPv6AddressTestCase {
    ...
    private static let hardcodedStringAndAddress: [Self] = [
        IPv6AddressTestCase(
            ...
            ip: (
                0x1111_2222_3333_4444_5555_6666_7777_8888, "1111:2222:3333:4444:5555:6666:7777:8888"
            )
        ),
        IPv6AddressTestCase("[FF::]", ip: (0x00FF_0000_0000_0000_0000_0000_0000_0000, "ff::")),
        IPv6AddressTestCase("[::FF]", ip: (0x0000_0000_0000_0000_0000_0000_0000_00FF, "::ff")),
        IPv6AddressTestCase("[0:FF::]", ip: (0x0000_00FF_0000_0000_0000_0000_0000_0000, "0:ff::")),
        IPv6AddressTestCase(
            "[2001:db8:85a3::100]",
        ...
        IPv6AddressTestCase(
            ...
            ip: (
                0x2001_0DB8_1111_2222_3333_4444_5555_6666, "2001:db8:1111:2222:3333:4444:5555:6666"
            )
        ),
        IPv6AddressTestCase(
            "[2001:db8:1111:2222:3333:4444:5555:0]",
            ip: (0x2001_0DB8_1111_2222_3333_4444_5555_0000, "2001:db8:1111:2222:3333:4444:5555:0")
        ),
        IPv6AddressTestCase(
            "[2001:DB8:1111:2222:0:3333:4444:5555]",
            ip: (0x2001_0DB8_1111_2222_0000_3333_4444_5555, "2001:db8:1111:2222:0:3333:4444:5555")
        ),
        IPv6AddressTestCase(
            "[2001::1:0:0:2]",
        ...
        IPv6AddressTestCase(
            ...
            ip: (0x2001_0DB8_AAAA_BBBB_CCCC_DDDD_EEEE_0001, "2001:db8:aaaa:bbbb:cccc:dddd:eeee:1")
        ),
        IPv6AddressTestCase(
            "2001:db8:aaaa:BBBB:cccc:dddd:eeee:1",
            ip: (0x2001_0DB8_AAAA_BBBB_CCCC_DDDD_EEEE_0001, "2001:db8:aaaa:bbbb:cccc:dddd:eeee:1")
        ...
        IPv6AddressTestCase("[::]", ip: (0x0000_0000_0000_0000_0000_0000_0000_0000, "::")),
        IPv6AddressTestCase("::", ip: (0x0000_0000_0000_0000_0000_0000_0000_0000, "::")),
        IPv6AddressTestCase(
            "[2001:0:0:1::]",
        ...
        IPv6AddressTestCase("[::1]", ip: (0x0000_0000_0000_0000_0000_0000_0000_0001, "::1")),
        IPv6AddressTestCase("::1", ip: (0x0000_0000_0000_0000_0000_0000_0000_0001, "::1")),
        IPv6AddressTestCase(
            "::FFFF:204.152.189.116",
            ip: (0x0000_0000_0000_0000_0000_FFFF_CC98_BD74, "::ffff:cc98:bd74"),
            mixedNotationDescription: "::ffff:204.152.189.116"
        ),
        IPv6AddressTestCase(
            "::FFFF:255.255.255.255",
            ip: (0x0000_0000_0000_0000_0000_FFFF_FFFF_FFFF, "::ffff:ffff:ffff"),
            mixedNotationDescription: "::ffff:255.255.255.255"
        ),
        IPv6AddressTestCase(
            "::FFFF:1.1.1.1",
        ...
        IPv6AddressTestCase(
            "64:ff9b::1",
            ip: (0x0064_FF9B_0000_0000_0000_0000_0000_0001, "64:ff9b::1"),
            mixedNotationDescription: "64:ff9b::0.0.0.1"
        ),
        IPv6AddressTestCase(
            "[64:ff9b::255.255.255.255]",
            ip: (0x0064_FF9B_0000_0000_0000_0000_FFFF_FFFF, "64:ff9b::ffff:ffff"),
            mixedNotationDescription: "64:ff9b::255.255.255.255"
        ),
        IPv6AddressTestCase(
            "64:ff9b::0.1.2.0",
            ip: (0x0064_FF9B_0000_0000_0000_0000_0001_0200, "64:ff9b::1:200"),
            mixedNotationDescription: "64:ff9b::0.1.2.0"
        ),
        IPv6AddressTestCase(
            "64:ff9b::255.255.0.0",
            ip: (0x0064_FF9B_0000_0000_0000_0000_FFFF_0000, "64:ff9b::ffff:0"),
            mixedNotationDescription: "64:ff9b::255.255.0.0"
        ),
        IPv6AddressTestCase(
            "64:ff9b:0:0:0:1:c000:221",
            ip: (0x0064_FF9B_0000_0000_0000_0001_C000_0221, "64:ff9b::1:c000:221")
        ),
        IPv6AddressTestCase(
            "64:ff9c::192.0.2.33",
            ip: (0x0064_FF9C_0000_0000_0000_0000_C000_0221, "64:ff9c::c000:221")
        ),
        IPv6AddressTestCase(
            "65:ff9b::192.0.2.33",
            ip: (0x0065_FF9B_0000_0000_0000_0000_C000_0221, "65:ff9b::c000:221")
        ),
        IPv6AddressTestCase(
            "0:64:ff9b::192.0.2.33",
            ip: (0x0000_0064_FF9B_0000_0000_0000_C000_0221, "0:64:ff9b::c000:221")
        ),
        IPv6AddressTestCase(
        ...
        IPv6AddressTestCase(
            "::ffff:0.0.0.1",
            ip: (0x0000_0000_0000_0000_0000_FFFF_0000_0001, "::ffff:0:1"),
            mixedNotationDescription: "::ffff:0.0.0.1"
        ),
        IPv6AddressTestCase(
            "::ffff:0.0.1.0",
            ip: (0x0000_0000_0000_0000_0000_FFFF_0000_0100, "::ffff:0:100"),
            mixedNotationDescription: "::ffff:0.0.1.0"
        ),
        IPv6AddressTestCase(
            "::ffff:0.0.1.2",
            ip: (0x0000_0000_0000_0000_0000_FFFF_0000_0102, "::ffff:0:102"),
            mixedNotationDescription: "::ffff:0.0.1.2"
        ),
        IPv6AddressTestCase(
            "::ffff:0.1.0.0",
            ip: (0x0000_0000_0000_0000_0000_FFFF_0001_0000, "::ffff:1:0"),
            mixedNotationDescription: "::ffff:0.1.0.0"
        ),
        IPv6AddressTestCase(
            "::ffff:0.1.2.0",
            ip: (0x0000_0000_0000_0000_0000_FFFF_0001_0200, "::ffff:1:200"),
            mixedNotationDescription: "::ffff:0.1.2.0"
        ),
        IPv6AddressTestCase(
            "::ffff:255.255.0.0",
            ip: (0x0000_0000_0000_0000_0000_FFFF_FFFF_0000, "::ffff:ffff:0"),
            mixedNotationDescription: "::ffff:255.255.0.0"
        ),
        IPv6AddressTestCase(
            "::ffff:255.0.0.0",
            ip: (0x0000_0000_0000_0000_0000_FFFF_FF00_0000, "::ffff:ff00:0"),
            mixedNotationDescription: "::ffff:255.0.0.0"
        ),
        IPv6AddressTestCase(
            "::ffff:0.0.255.255",
            ip: (0x0000_0000_0000_0000_0000_FFFF_0000_FFFF, "::ffff:0:ffff"),
            mixedNotationDescription: "::ffff:0.0.255.255"
        ),
        IPv6AddressTestCase(
            "::ffff:9.8.7.6",
            ip: (0x0000_0000_0000_0000_0000_FFFF_0908_0706, "::ffff:908:706"),
            mixedNotationDescription: "::ffff:9.8.7.6"
        ),
        IPv6AddressTestCase(
            "::ffff:192.0.2.128",
            ip: (0x0000_0000_0000_0000_0000_FFFF_C000_0280, "::ffff:c000:280"),
            mixedNotationDescription: "::ffff:192.0.2.128"
        ),
        IPv6AddressTestCase(
            "::fffe:255.255.255.255",
            ip: (0x0000_0000_0000_0000_0000_FFFE_FFFF_FFFF, "::fffe:ffff:ffff")
        ),
        IPv6AddressTestCase(
            "::1:ffff:1.1.1.1",
            ip: (0x0000_0000_0000_0000_0001_FFFF_0101_0101, "::1:ffff:101:101")
        ),
        IPv6AddressTestCase(
            "1::ffff:1.1.1.1",
            ip: (0x0001_0000_0000_0000_0000_FFFF_0101_0101, "1::ffff:101:101")
        ),
        IPv6AddressTestCase(
            "0:0:0:0:ffff:0:1.1.1.1",
            ip: (0x0000_0000_0000_0000_FFFF_0000_0101_0101, "::ffff:0:101:101")
        ),
        IPv6AddressTestCase(
            "64:ff9b:1::192.0.2.33",
            ip: (0x0064_FF9B_0001_0000_0000_0000_C000_0221, "64:ff9b:1::c000:221")
        ),
        IPv6AddressTestCase(
            "fe80::5efe:192.0.2.33",
            ip: (0xFE80_0000_0000_0000_0000_5EFE_C000_0221, "fe80::5efe:c000:221")
        ),
        IPv6AddressTestCase(
            "2002:c000:221::1",
            ip: (0x2002_C000_0221_0000_0000_0000_0000_0001, "2002:c000:221::1")
        ),
        IPv6AddressTestCase(
            "::1:2:3:4:5:6:7",
            ip: (0x0000_0001_0002_0003_0004_0005_0006_0007, "0:1:2:3:4:5:6:7")
        ),
        IPv6AddressTestCase(
            "1:2:3:4:5:6:7::",
            ip: (0x0001_0002_0003_0004_0005_0006_0007_0000, "1:2:3:4:5:6:7:0")
        ),
        IPv6AddressTestCase(
            "1:2:3::4:5:6:7",
            ip: (0x0001_0002_0003_0000_0004_0005_0006_0007, "1:2:3:0:4:5:6:7")
        ),
        ...
        IPv6AddressTestCase(
            ...
            ip: (0x2001_0db8_1234_5678_abcd_ef01_2345_0067, "2001:db8:1234:5678:abcd:ef01:2345:67")
        ),
        IPv6AddressTestCase(
            "2001:db8::0",
        ...
        IPv6AddressTestCase("::1:1", ip: (0x0000_0000_0000_0000_0000_0000_0001_0001, "::1:1")),
        IPv6AddressTestCase(
            "::ff:1:1:7.0.0.1",
        ...
        IPv6AddressTestCase(
            ...
            mixedNotationDescription: "::ffff:127.0.0.1"
        ),
        IPv6AddressTestCase(
            "::ffff:1:7.0.0.1",
        ...
        IPv6AddressTestCase("F::", ip: (0x000f_0000_0000_0000_0000_0000_0000_0000, "f::")),
        IPv6AddressTestCase(
    ...
    static let idnaStringAndAddress: [Self] = [
        ...
        IPv6AddressTestCase(
            ...
            ip: (
                0x2001_0DB8_85A3_F109_197A_8A2E_0370_7334, "2001:db8:85a3:f109:197a:8a2e:0370:7334"
            )
        ),
    ...
    private static let ipv4Embedded: [Self] = IPv4DecimalLengthTestCase.all.flatMap { octets in
        [
            Self(
                "::ffff:\(octets.string)",
                ip: (octets.address.asIPv4MappedIPv6, octets.ipv4MappedExpandedIPv6Description),
                mixedNotationDescription: "::ffff:\(octets.description)"
            ),
            Self(
