    ...
    static var stringAndAddress: [Self] {
        [
            ...
            IPTestCase(
                ...
                ip: (0x0000_0000_0000_0000_0000_FFFF_CC98_BD74, "[::ffff:204.152.189.116]")
            ),
            IPTestCase(
                "::FFFF:255.255.255.255",
                ip: (0x0000_0000_0000_0000_0000_FFFF_FFFF_FFFF, "[::ffff:255.255.255.255]")
            ),
            IPTestCase(
                "::FFFF:1.1.1.1",
                ip: (0x0000_0000_0000_0000_0000_FFFF_0101_0101, "[::ffff:1.1.1.1]")
            ),
            IPTestCase(
                "[::ffff:1.1.1.1]",
                ip: (0x0000_0000_0000_0000_0000_FFFF_0101_0101, "[::ffff:1.1.1.1]")
            ...
            IPTestCase(
                "::ffff:0.0.0.0",
                ip: (0x0000_0000_0000_0000_0000_FFFF_0000_0000, "[::ffff:0.0.0.0]")
            ),
            IPTestCase(
                "::ffff:192.0.2.128",
                ip: (0x0000_0000_0000_0000_0000_FFFF_C000_0280, "[::ffff:192.0.2.128]")
            ),
            IPTestCase(
            ...
            IPTestCase(
                "::ffff:127.0.0.1",
                ip: (0x0000_0000_0000_0000_0000_ffff_7f00_0001, "[::ffff:127.0.0.1]")
            ),
            IPTestCase(
                "::ffff:1:7.0.0.1",
