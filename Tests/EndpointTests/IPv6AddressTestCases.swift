...
extension IPTestCase where IPAddressType == IPv6Address {
    ...
    static var stringAndAddress: [Self] {
        [
            ...
            IPTestCase(
                "[2001::1:0:0:2]",
                0x2001_0000_0000_0000_0001_0000_0000_0002,
            ...
            IPTestCase(
                "[2001:0:0:1::]",
                0x2001_0000_0000_0001_0000_0000_0000_0000,
                canonicalDescription: "[2001:0:0:1::]"
            ),
            IPTestCase(
                "[::1:0:0:2]",
                0x0000_0000_0000_0000_0001_0000_0000_0002,
                canonicalDescription: "[::1:0:0:2]"
            ),
            IPTestCase(
                "[::1:2:3:0:4:5]",
                0x0000_0000_0001_0002_0003_0000_0004_0005,
                canonicalDescription: "[::1:2:3:0:4:5]"
            ),
            IPTestCase(
                "[::1:0:0:1:0:0]",
                0x0000_0000_0001_0000_0000_0001_0000_0000,
                canonicalDescription: "[::1:0:0:1:0:0]"
            ),
            IPTestCase(
                "[1:0:1::1:0]",
                0x0001_0000_0001_0000_0000_0000_0001_0000,
            ...
            IPTestCase(
                "::13.1.68.3",
                0x0000_0000_0000_0000_0000_0000_0D01_4403,
            ...
            IPTestCase("0:0:0:0:0:0:FFFF:1.1.1.1"),
            IPTestCase("0:0:0:0:FFFF:1.1.1.1:FFFF"),
            IPTestCase("0:0:0:0:0:1.1.1.1:FFFF"),
            IPTestCase("::FFFF:1.1.1.1:FFFF"),
            IPTestCase("::1.1.1.1:FFFF"),
            IPTestCase(":FFFF:1.1.1.1"),
            IPTestCase("::FFFF:1."),
            IPTestCase("::FFFF:1.1"),
            IPTestCase("::FFFF:1.1."),
            IPTestCase("::FFFF:1.1.1"),
            IPTestCase("::FFFF:1.1.1."),
            IPTestCase(
                "::1.1.1.1",
                0x0000_0000_0000_0000_0000_0000_0101_0101,
                canonicalDescription: "[::101:101]"
            ),
            IPTestCase(".1.1.1.1"),
            IPTestCase("::FFFF:256.152.189.116"),
            IPTestCase("[0000:0000:0000:0000:0000:FFFF:255.255.255.1111]"),
            IPTestCase("::FFFF:204.152.189.116."),
            IPTestCase("::FFFF:.204.152.189.116"),
            IPTestCase("::FFFF::204.152.189.116"),
            IPTestCase("::FFFF:204.152.189"),
            IPTestCase("::FFFF:204.152.189."),
            IPTestCase("::FFFF:.204.152.189"),
            IPTestCase(""),
            IPTestCase(" "),
            ...
            IPTestCase("::::::::::"),
            IPTestCase("[::::::::::]"),
            IPTestCase("[2001:0:0:1:::]"),
            IPTestCase("[:::2001:0:0:1]"),
            IPTestCase("[2001:0:0:1::2"),
            IPTestCase("2001:0:0:1::2]"),
            IPTestCase("[1::2::]"),
            IPTestCase("[1::2::3]"),
            ...
            IPTestCase("[0:1:2:3:4:0:5:6:]"),
            IPTestCase("[0:1:2:3:4:0:5:6:]"),
            IPTestCase("[::0:1:2:3:4:5:6:7]"),
            IPTestCase("[0:1:2:3:4:5:6:7::]"),
            IPTestCase("[0:1:2:3:4:0:5]"),
            IPTestCase("[1:2:3:4:5:6:7]"),
            IPTestCase("[1:2:3:4:5:6:7:8:9]"),
            IPTestCase("[1:2:3]"),
            IPTestCase("[1:2:3:]"),
            IPTestCase("[:1:2:3]"),
            IPTestCase("[0:1:2:3:4:0:5:6:7]"),
            IPTestCase("[0:1:2:3:4:0:5:-6]"),
            IPTestCase("[0:1:2:3:4:0:5:g]"),
            IPTestCase("[0:11111:2:3:4:0:5:6]"),
            IPTestCase("[0:11111::]"),
            IPTestCase("[::11111:0]"),
            IPTestCase("[11111::]"),
            IPTestCase("[::11111]"),
            ...
            IPTestCase("::1\n"),
            IPTestCase("::1\t"),
            IPTestCase("::FFFF:1.2.3.4 "),
            IPTestCase("fe80::1%eth0"),
            IPTestCase("::ffff:1.2.3.4.5"),
            IPTestCase("::ffff:1.2.3.4:"),
            IPTestCase("::ffff:1.2.3"),
            IPTestCase("::ffff:0x1.2.3.4"),
            IPTestCase("::ffff:999.1.1.1"),
            IPTestCase("1::2:3:4:5:6:7:8"),
            IPTestCase(
                "0:00:000:0000:0:0:0:0",
                0,
                canonicalDescription: "[::]"
            ),
            IPTestCase(
            ...
            IPTestCase(
                "[0:00:000:0000:0:0:0:1]",
                1,
                canonicalDescription: "[::1]"
            ),
            IPTestCase("192.168.1.255", isValidAsOtherIPVersion: true),
            /// Imported from glibc `resolv/tst-inet_pton.c`.
            IPTestCase(".:"),
            IPTestCase("0.:"),
            IPTestCase("00"),
            IPTestCase("0000000"),
            IPTestCase("00000000000000000"),
            IPTestCase("092."),
            IPTestCase("10.0.301.2"),
            IPTestCase("19.."),
            IPTestCase("192.0.2.-1"),
            IPTestCase("192.0.2.1."),
            IPTestCase("192.0.2.1192."),
            IPTestCase("192.0.2.256"),
            IPTestCase("192.0.201."),
            IPTestCase("192.0.261."),
            IPTestCase("192.062."),
            IPTestCase("192.192.00n2.1."),
            IPTestCase("192.192.2.190."),
            IPTestCase("192.255.255.2555"),
            IPTestCase(
                "1:1::1:1",
                0x0001_0001_0000_0000_0000_0000_0001_0001,
                canonicalDescription: "[1:1::1:1]"
            ),
            IPTestCase("2"),
            IPTestCase("2."),
            IPTestCase("2001:db8:00001::f"),
            IPTestCase("2001:db8:10000::f"),
            IPTestCase(
            ...
            IPTestCase("2001:db8:1234:5678:abcd:ef01:2345:6789:1"),
            IPTestCase("2001:db8:1234:5678:abcd:ef01:2345::6789"),
            IPTestCase(
                "2001:db8::0",
            ...
            IPTestCase(
                "2001:db8::19",
                0x2001_0db8_0000_0000_0000_0000_0000_0019,
            ...
            IPTestCase(
                "2001:db8::4",
                0x2001_0db8_0000_0000_0000_0000_0000_0004,
                canonicalDescription: "[2001:db8::4]"
            ),
            IPTestCase(
                "2001:db8::5",
                0x2001_0db8_0000_0000_0000_0000_0000_0005,
            ...
            IPTestCase(
                "2001:db8::8",
                0x2001_0db8_0000_0000_0000_0000_0000_0008,
                canonicalDescription: "[2001:db8::8]"
            ),
            IPTestCase(
                "2001:db8::9",
                0x2001_0db8_0000_0000_0000_0000_0000_0009,
                canonicalDescription: "[2001:db8::9]"
            ),
            IPTestCase(
                "2001:db8::A",
                0x2001_0db8_0000_0000_0000_0000_0000_000a,
                canonicalDescription: "[2001:db8::a]"
            ),
            IPTestCase(
                "2001:db8::B",
                0x2001_0db8_0000_0000_0000_0000_0000_000b,
                canonicalDescription: "[2001:db8::b]"
            ),
            IPTestCase(
                "2001:db8::C",
                0x2001_0db8_0000_0000_0000_0000_0000_000c,
                canonicalDescription: "[2001:db8::c]"
            ),
            IPTestCase(
                "2001:db8::D",
                0x2001_0db8_0000_0000_0000_0000_0000_000d,
                canonicalDescription: "[2001:db8::d]"
            ),
            IPTestCase(
                "2001:db8::E",
                0x2001_0db8_0000_0000_0000_0000_0000_000e,
                canonicalDescription: "[2001:db8::e]"
            ),
            IPTestCase(
                "2001:db8::F",
                0x2001_0db8_0000_0000_0000_0000_0000_000f,
            ...
            IPTestCase("22"),
            IPTestCase("2222@"),
            IPTestCase("255.255.255.25555"),
            IPTestCase("2:"),
            IPTestCase("2:ff:1:1:7:ff:1:1:7."),
            IPTestCase(
            ...
            IPTestCase(
                "::ff:1:1:7.0.0.1",
                0x0000_0000_0000_00ff_0001_0001_0700_0001,
                canonicalDescription: "[::ff:1:1:700:1]"
            ),
            IPTestCase("::ff:1:1:7:ff:1:1:7."),
            IPTestCase("::ff:1:1:7ff:1:8:7.0.0.1"),
            IPTestCase("::ff:1:1:7ff:1:8f:1:1:71"),
            IPTestCase("::ffff:02fff:127.0.S1"),
            IPTestCase(
                "::ffff:127.0.0.1",
            ...
            IPTestCase(
                "::ffff:1:7.0.0.1",
                0x0000_0000_0000_0000_ffff_0001_0700_0001,
                canonicalDescription: "[::ffff:1:700:1]"
            ),
            IPTestCase("A:f:ff:1:1:D:ff:1:1::7."),
            IPTestCase("AAAAA."),
            IPTestCase("D:::"),
            IPTestCase("DF8F"),
            IPTestCase(
                "F::",
                0x000f_0000_0000_0000_0000_0000_0000_0000,
            ...
            IPTestCase("ffff:ff:ff:fff:ff:ff:ff:"),
...
extension IPTestCase where IPAddressType == IPv6Address {
    ...
    static var idnaStringAndAddress: [Self] {
        [
            ...
            IPTestCase("[\u{AD}::]", 0x0000_0000_0000_0000_0000_0000_0000_0000),
            IPTestCase("[::\u{AD}]", 0x0000_0000_0000_0000_0000_0000_0000_0000),
            IPTestCase("[1:\u{AD}:1]", 0x0001_0000_0000_0000_0000_0000_0000_0001),
            IPTestCase("[1:\u{AD}\u{200B}:1]", 0x0001_0000_0000_0000_0000_0000_0000_0001),
        ]
    }
}
...
private let ipv6BoundaryCharacters: [UInt8] = [
    UInt8(ascii: ":") + 1,
...
extension IPTestCase where IPAddressType == IPv6Address {
    private static var boundaryCharacters: [Self] {
        ipv6BoundaryCharacters.map { utf8Byte in
            let char = String(UnicodeScalar(utf8Byte))
            return IPTestCase("::1:\(char):1")
        }
    }
}
