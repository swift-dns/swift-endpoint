...
extension IPv6AddressTestCase {
    ...
    static var stringAndAddress: [Self] {
        [
            ...
            IPv6AddressTestCase(
                "::ffff:1.2.0.0",
                ip: (0x0000_0000_0000_0000_0000_FFFF_0102_0000, "::ffff:102:0"),
                mixedNotationDescription: "::ffff:1.2.0.0"
            ),
            IPv6AddressTestCase(
                "::ffff:255.255.0.0",
            ...
            IPv6AddressTestCase(
                "::ffff:0.0.0.10",
                ip: (0x0000_0000_0000_0000_0000_FFFF_0000_000A, "::ffff:0:a"),
                mixedNotationDescription: "::ffff:0.0.0.10"
            ),
            IPv6AddressTestCase(
                "::ffff:1.0.0.0",
                ip: (0x0000_0000_0000_0000_0000_FFFF_0100_0000, "::ffff:100:0"),
                mixedNotationDescription: "::ffff:1.0.0.0"
            ),
            IPv6AddressTestCase(
                "::ffff:255.0.0.0",
        ...
        ] + Self.boundaryCharacters + Self.ipv4Embedded
    }
...
extension IPv4EmbeddedIPv6TestCase {
    static var all: [Self] {
        [
            IPv4EmbeddedIPv6TestCase("::ffff:c000:0280", IPv4Address(192, 0, 2, 128)),
            IPv4EmbeddedIPv6TestCase("::ffff:1234:5678", IPv4Address(18, 52, 86, 120)),
            IPv4EmbeddedIPv6TestCase("::ffff:abcd:ef01", IPv4Address(171, 205, 239, 1)),
            IPv4EmbeddedIPv6TestCase("::ffff:7f00:0001", IPv4Address(127, 0, 0, 1)),
            IPv4EmbeddedIPv6TestCase("::ffff:0:0", IPv4Address(0, 0, 0, 0)),
            IPv4EmbeddedIPv6TestCase("::ffff:0:102", IPv4Address(0, 0, 1, 2)),
            IPv4EmbeddedIPv6TestCase("::ffff:102:0", IPv4Address(1, 2, 0, 0)),
            IPv4EmbeddedIPv6TestCase("::ffff:ffff:0", IPv4Address(255, 255, 0, 0)),
            IPv4EmbeddedIPv6TestCase("0:0:1:0:0:ffff:abcd:ef01"),
            IPv4EmbeddedIPv6TestCase("ffff:ffff:ffff:ffff:ffff:ffff:abcd:ef01"),
        ]
    }
}
